...
public class ScanEffect : MonoBehaviour
{
    ...
    [SerializeField] private Material invisibleGlowMaterialForChain;
    ...
    public IEnumerator ScanCoroutine()
    {
        ...
        invisibleGlowMaterialForChain.SetFloat("_Alpha",1f);
    ...
    IEnumerator FadeCoroutine()
    {
        ...
        while (elapsedTime < 1f)
        {
            ...
            invisibleGlowMaterialForChain.SetFloat("_Alpha", alpha);
        ...
        invisibleGlowMaterialForChain.SetFloat("_Alpha", 0f);
