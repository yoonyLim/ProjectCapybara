...
Shader "TidalFlask/Foliage Wind URP TextureBlend Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float3 temp_output_72_0 = ( saturate( ( bakedGI75 + clampResult116 ) ) * _MainLightColor.rgb );
...
/*ASEBEGIN
Version=18912
349;503;1906;786;2571.46;1707.213;2.009655;True;False
...
Node;AmplifyShaderEditor.SamplerNode;426;640.7825,271.4628;Inherit;True;Property;_BlendTexture;Blend Texture;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;85;821.611,1403.038;Inherit;False;Property;_DistanceFadeColor;Distance Fade Color;11;0;Create;True;0;0;0;False;0;False;0.3820755,0.8960492,1,1;0.5333334,0.6745098,0.1607843,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=95937753A4B6DFB288233406E35B75D210B74450