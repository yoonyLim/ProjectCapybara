...
namespace DistantLands.Cozy.Data
{
    ...
    public class ClimateProfile : CozyProfile
    {
        ...
        public float GetHumidity(CozyWeather weather, float inTime)
        {
            ...
            float nextDays = inTime;
            float i = (humidityOverYear.Evaluate((weather.timeModule.DayAndTime() + nextDays) / weather.timeModule.perennialProfile.daysPerYear) * humidityOverDay.Evaluate(weather.timeModule.modifiedDayPercentage)) + humidityFilter;
