...
namespace DistantLands.Cozy.EditorScripts
{
    ...
    public class CozyWindModuleEditor : CozyModuleEditor
    {
        ...
        public override Button DisplayWidget()
        {
            ...
            status.text = $"Wind: {Mathf.Round(windModule.windSpeed * windModule.windMultiplier * 10f) / 10f} {compassDirection}";
        ...
        public VisualElement Weathervane()
        {
            ...
            label.text = $"{Mathf.Round(windModule.windSpeed * windModule.windMultiplier * 10f) / 10f} kn";
